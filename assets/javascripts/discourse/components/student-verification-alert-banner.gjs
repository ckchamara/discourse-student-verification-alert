...
export default class StudentVerificationAlertBanner extends Component {
  ...
  get message() {
    return this.siteSettings.student_verification_alert_message ||
           "Verify before you start posting as student, please click <img src='/plugins/discourse-student-verification-alert/images/unverified-label.svg' alt='verify' style='display: inline; height: 16px; margin: 0 4px; vertical-align: middle;'> in the header.";
  }
